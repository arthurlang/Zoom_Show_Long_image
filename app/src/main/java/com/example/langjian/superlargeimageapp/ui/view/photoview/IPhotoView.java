...
public interface IPhotoView {
    ...
    float DEFAULT_MAX_SCALE = 1.5f;
    float DEFAULT_MID_SCALE = 1.25f;
    ...
    /**
     * Sets whether to support the two times zoom
     *
     * @param supportTwiceZoom boolean value of  whether to support the two times zoom
     */
    void setSupportTwiceZoom(boolean supportTwiceZoom);

    /**
     * support two times scale
     *
     * @return support two times scale if true,
     */
    boolean supportTwiceZoom();


    /**
     * set Gesture Scale
     */
    void setMinGestureScale(float scale);

    /**
     * get Gesture Scale
     *
     * @return get Gesture Scale
     */
    float getMinGestureScale();
