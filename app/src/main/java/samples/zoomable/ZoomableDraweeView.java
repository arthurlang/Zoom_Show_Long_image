    ...
    private void init() {
        ...
        setTapListener(new GestureDetector.SimpleOnGestureListener(){
            ...
            public boolean onDown(MotionEvent e) {
                imagePoint.set(e.getX(),e.getY());
                viewPoint.set(e.getX(),e.getY());
            ...
            public boolean onDoubleTapEvent(MotionEvent e) {
                ...
                if (mZoomableController.getScaleFactor() > 1){
                    mZoomableController.zoomToPoint(1f,new PointF(),new PointF(),DefaultZoomableController.LIMIT_ALL,300, null);
                }else{
                    mZoomableController.zoomToPoint(1.5f,imagePoint,viewPoint,DefaultZoomableController.LIMIT_ALL,300, null);
                }
                return true;
            }
        });
