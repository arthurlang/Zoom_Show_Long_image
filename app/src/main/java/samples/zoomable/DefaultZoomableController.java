...
//    return isMatrixIdentity(mActiveTransform, 1e-3f);
  ...
  private float mMin = 0f,mMax = 0;
  private boolean isInterept;
  private void onTransformChanged() {
    if (mMax == 0){
      mMax = UIHelper.getScreenWidth();
    }
    isInterept = mTransformedImageBounds.left == mMin || mTransformedImageBounds.right == mMax;
...
//
//    float lastY = mTempValues[5];
//    if (mLastY != lastY){
//      count=0;
//      mLastY = mTempValues[5];
//      return false;
//    }else{
//      count++;
//      mLastY = mTempValues[5];
